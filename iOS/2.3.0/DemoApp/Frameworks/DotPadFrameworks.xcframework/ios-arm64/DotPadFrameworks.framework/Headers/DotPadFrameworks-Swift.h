...
#ifndef DOTPADFRAMEWORKS_SWIFT_H
#define DOTPADFRAMEWORKS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DotPadFrameworks",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16DotPadFrameworks19DotPadCommunication")
@interface DotPadCommunication : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC16DotPadFrameworks22NewDotPadCommunication")
@interface NewDotPadCommunication : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
