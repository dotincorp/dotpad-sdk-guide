...
#define DOTPADSDK_API __declspec(dllimport)
	...
	namespace DOT_PAD_SDK_API {
		...
		DOTPADSDK_API DOT_PAD_SDK_ERROR DOT_PAD_GET_DISPLAY_INFO(void(CALLBACK* cb)(int, int));
		...
		typedef DOT_PAD_SDK_ERROR(*DOT_PAD_GET_DISPLAY_INFO_FUNC)(void(CALLBACK* cb)(int, int));
