...
#define DOTPADSDK_API __declspec(dllimport)
	...
	namespace DOT_PAD_SDK_API {
		...
		DOTPADSDK_API DOT_PAD_SDK_ERROR DOT_PAD_REGISTER_MULTI_KEY_CALLBACK(void(CALLBACK* cb)(int), int interval);
		...
		typedef DOT_PAD_SDK_ERROR(*DOT_PAD_REGISTER_MULTI_KEY_CALLBACK_FUNC)(void(CALLBACK* cb)(int), int interval);
