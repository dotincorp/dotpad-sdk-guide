...
import { DotPadScanner, DotPadSDK, DotDevice, DataCodes, DisplayMode, DotPadKey, BrailleLanguage, GradeOption, NumberOfBraillePerLine, LiblouisManager } from "./sdk/DotPadSDK-3.0.2";
import "./App.css";
