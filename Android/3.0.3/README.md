...
└── DemoApp/
    └── appnew/
        ├── libs/
        │   └── DotPadFrameworks-3.0.3.aar   ← SDK library
        ├── assets/
...
| العربية (Arabic) | Grade1, Grade2 | Dot |
...
| Nederlands (Dutch) | Grade1, Grade2 | LibLouis |
| Română (Romanian) | — | LibLouis |
| Magyar (Hungarian) | Grade1, Grade2 | LibLouis |
| Cymraeg (Welsh) | Grade1, Grade2 | LibLouis |
| Србија (Serbian) | — | LibLouis |
| Hrvatski (Croatian) | — | LibLouis |
